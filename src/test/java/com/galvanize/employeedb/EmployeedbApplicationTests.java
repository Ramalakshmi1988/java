...
//        //Setup
//        given(employeeRepository.findAll()).willReturn(new ArrayList<Employee>() {
//                                                           @Override
...
//        Employee employee = new Employee(1L, "Joe Test", "123 Any Street", "Anytown", "GA", "30269", sdf.parse("2018/12/12"));
//
